...
class EditNomorKontakAlamatActivity : AppCompatActivity() {
    private lateinit var binding: ActivityEditTextBinding
    private var nomorKontak: String? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nomorKontak = intent.getStringExtra(Cons.EXTRA_NAMA)
        alamatId = intent.getStringExtra(Cons.EXTRA_ID)

        ibSave = binding.ibSave
        progressBar = binding.progressBar
        etNomorKontak = binding.edAddName
    ...
    private fun setupView() {
        tvTitle.text = getString(R.string.nomor_kontak)
        tvName.text = getString(R.string.nomor_kontak)
        etNomorKontak.setText(nomorKontak)
        etNomorKontak.inputType = InputType.TYPE_CLASS_NUMBER
    }

    private fun updateNomorKontak() {
