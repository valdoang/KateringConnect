...
class DeleteGalleryFragment: DialogFragment() {
            ...
            db.collection("gallery").document(galleryId).get()
                .addOnSuccessListener {
                    if (it != null) {
                        ...
                        db.collection("gallery").document(galleryId).delete()
                        storageRef.getReference("vendorGallery").child(storageKeys).delete()
                            .addOnSuccessListener {
                                dismiss()
