...
import com.valdoang.kateringconnect.databinding.ItemKategoriVendorMenuBinding
...
class KategoriVendorMenuAdapter(
    private val context: Context
): RecyclerView.Adapter<KategoriVendorMenuAdapter.MyViewHolder>() {
    ...
    inner class MyViewHolder(private val binding: ItemKategoriVendorMenuBinding) :
        ...
        fun bind(kategoriMenu: KategoriMenu) {
            binding.apply {
                ...
                val vendorMenuAdapter = VendorMenuAdapter(context, kategoriMenu.id!!)
                recyclerView.layoutManager = LinearLayoutManager(context)
                recyclerView.adapter = vendorMenuAdapter
                vendorMenuAdapter.setItems(menuList)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = ItemKategoriVendorMenuBinding.inflate(LayoutInflater.from(parent.context), parent, false)
